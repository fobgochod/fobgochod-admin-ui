<template>
    <frame-space>
        ...
        <data-infrastructure table='Task' :success='getByPage'></data-infrastructure>
...
import DataInfrastructure from '../../components/comm/DataInfrastructure'

export default {
    components: {DataInfrastructure},
    mixins: [pageMixin],
    data() {
        return {
            formData: {
